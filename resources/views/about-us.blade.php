<x-layout title='About us'>
  ...
  <div class="flex flex-col gap-12 my-auto justify-center items-center w-full">
    <div class="w-full max-w-screen-xl mx-auto py-8 flex flex-col">
    ...
    <div class="flex flex-col gap-12 my-auto justify-center items-center w-full">
      <div class="w-full max-w-screen-xl mx-auto py-8 flex flex-col gap-8 px-4 md:px-0">
        <h3 class="text-3xl">HMOs prioritize physical health, EAPs focus on mental heath. True wellness demands both since they are interdependent.</h3>
