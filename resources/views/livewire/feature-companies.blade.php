      ...
      @foreach ($featuredCompanies as $company)
        <div>
          @if($company->logo_path)
            <img src="{{ Storage::disk('resource')->url($company->logo_path) }}" alt="{{ $company->name }}" class="h-12 md:h-24 mx-4 my-8 inline-block object-contain" loading="lazy" />
          @else
