<div>
  <flux:modal name="edit-team-member" class="md:w-256" flyout>
      <div class="space-y-6">
          <div>
              <flux:heading size="lg">Update team member</flux:heading>
          ...
          <label class="block text-sm font-medium text-white">Photo Image</label>
          ...
          @if ($photo)
            <img src="{{ $photo->temporaryUrl() }}" class="w-1/2" alt="Preview">
          @elseif ($this->photo_path)
            <img src="{{ Storage::disk('resource')->url($this->photo_path) }}" class="w-1/2" alt="Current photo">
          @endif
