  ...
  <div class="flex flex-col gap-12 justify-between items-center w-full">
          ...
          <ul class="flex flex-wrap items-stretch mx-auto gap-4 my-auto max-w-screen-xl px-0">
            ...
            <li class="flex flex-col items-start justify-between flex-1 min-w-[160px] min-h-[200px] min-h-[244px] h-full bg-white rounded-lg border border-gray-200 p-4 gap-2 text-left hover:shadow-sm transition">
              <div class="flex flex-col gap-4">
                ...
                <div class="text-teal-800 text-md font-bold t-2">Marketing &amp; Promotions</div>
              </div>
              <svg class="self-start" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon-circle-bg-40"></use>
            ...
            <li class="flex flex-col items-start justify-between flex-1 min-w-[160px] min-h-[200px] min-h-[244px] h-full bg-white rounded-lg border border-gray-200 p-4 gap-2 text-left hover:shadow-sm transition">
              <div class="flex flex-col gap-4">
                ...
                <div class="text-teal-800 text-md font-bold mt-2">HR Consultations</div>
              </div>
              <svg class="self-start" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon-circle-bg-40"></use>
            ...
            <li class="flex flex-col items-start justify-between flex-1 min-w-[160px] min-h-[200px] min-h-[244px] bg-white rounded-lg border border-gray-200 p-4 gap-2 text-left hover:shadow-sm transition">
              <div class="flex flex-col gap-4">
                ...
                <div class="text-teal-800 text-md font-bold mt-2">Policy Development &amp; Review</div>
              </div>
              <svg class="self-start" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon-circle-bg-40"></use>
            ...
            <li class="flex flex-col items-start justify-between flex-1 min-w-[160px] min-h-[200px] min-h-[244px] bg-white rounded-lg border border-gray-200 p-4 gap-2 text-left hover:shadow-sm transition">
              <div class="flex flex-col gap-4">
                ...
                <div class="text-teal-800 text-md font-bold mt-2">Monitoring &amp; Evaluation</div>
              </div>
              <svg class="self-start" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon-circle-bg-40"></use>
    ...
    <div class="w-full bg-white h-72 md:h-auto">
      <div class="flex items-center mx-auto flex-col gap-4 my-auto max-w-screen-xl xl:px-0 px-8 md:px-0 lg:px-8 h-full">
        <div class="flex gap-8 md:gap-12 items-center justify-center bg-gray-50 bg-[url('/images/custom-background.png')] bg-center bg-cover rounded-lg overflow-clip flex-col my-auto relative md:w-[800px]:h-52 lg:w-full h-72 px-8">
          <h3 class="text-3xl font-semibold">Want custom programs &amp; services? No problem!</h3>
          <div>
    ...
    <div class="w-full bg-teal-700 h-auto">
      <div class="flex items-center flex-col justify-between px-8 py-12 gap-4">
        <h3 class="text-4xl text-white text-center pt-8">Ready to transform your workplace culture?</h3>
        <p class="text-white font-semibold">Our sales team will reach out to schedule a demo with you or see how we can help.</p>
        <div>
          <button class="h-12 cursor-pointer font-semibold text-sm w-64 bg-white border-transparent rounded-lg px-4 py-2 text-teal-500">Book a Discovery Call</button>
        </div>
        <p class="text-white my-8">Looking for help as a member or employee? Email us at <a href="mailto:info@infinitcare.co" class="text-teal-200">info@infinitcare.co</span></a>
      </div>
    </div>
  </div>
</x-layout>